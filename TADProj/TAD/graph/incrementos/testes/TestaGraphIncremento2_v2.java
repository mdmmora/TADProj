...
import br.pucrs.adt.incrementos.v2.GraphDirListAdj;
import br.pucrs.adt.incrementos.v2.GraphDirMatAdj;

public class TestaGraphIncremento2_v2 {
...
//		System.out.println("");
//
//		System.out.println("\n\n Caminho de A at� E - Grafo 1 - Lista");
//		System.out.println("\n " + grf1.singleSourceSingleDestRec("A", "E"));
//		
//
//		System.out.println("\n\n Caminho de A at� E - Grafo 2 - Matriz");
//		System.out.println("\n " + grf2.singleSourceSingleDestRec("A", "E"));
//		
//		System.out.println("Alca�avel:");
...
//		
//		System.out.println("Dois n�veis a frente:");
//		System.out.println("Do A: ->" + grf1.getTwoLevelsAhead("A"));
		...
		System.out.println("Grafo Lista - Amplitude");
		List<String> l = g1.traversalWidth("A");
		for (String aux:l)
			System.out.print(aux + " ");
		System.out.println("");

		System.out.println("Grafo Matriz - Amplitude");
		l = g2.traversalWidth("A");
		for (String aux:l)
			System.out.print(aux + " ");
		System.out.println("");

		System.out.println("Grafo Lista - Profundidade");
		l = g1.traversalDepth("A");
		for (String aux:l)
			System.out.print(aux + " ");
		System.out.println("");

		System.out.println("Grafo Matriz - Profundidade");
		l = g2.traversalDepth("A");
		for (String aux:l)
			System.out.print(aux + " ");
		System.out.println("");
