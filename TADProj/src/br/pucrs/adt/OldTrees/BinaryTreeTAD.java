...
public interface BinaryTreeTAD<Dado> {
	...
	/**
	 * Recupera o dado armazenado no filho da esquerda do nodo corrente da árvore.
	 * @return    Dado armazenado à esquerda do nodo corrente. 
	 */
	public abstract Dado getLeft();
	
	
	/**
	 * Recupera o dado armazenado no filho da direita do nodo corrente da árvore.
	 * @return    Dado armazenado à direita do nodo corrente. 
	 */
